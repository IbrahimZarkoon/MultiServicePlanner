            ...
            child: Column(
              ...
              children: [
                ...
                ListView.builder(
                  ...
                  {
                    return newNotifCon(context, "https://images.pexels.com/photos/2114703/pexels-photo-2114703.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500",
    ...
    return InkWell(
      onTap: ()
      {
        showModalBottomSheet(
            ...
            {
              return NotifBottomModal( image: image, content: content,);
            });
      },
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Container(
              ...
              child: ClipRRect(
                borderRadius: BorderRadius.circular(100),
                child: Icon(CupertinoIcons.bell_fill,color: primaryColor,size: MediaQuery.sizeOf(context).height*0.035,),
              ),
            ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  RichText(
                    ...
                    children: <TextSpan>[
                      TextSpan(
                        text: "Great news! Your booking has been confirmed.",
