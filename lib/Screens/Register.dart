                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children:  const [
                              ...
                              Text("Create your account",overflow: TextOverflow.ellipsis,
                                  style:
                                  TextStyle(fontFamily: "",color: Colors.white,fontWeight: FontWeight.bold, fontSize: 30)),
                            ],
                          ),
                        ),
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children:  const [
                              ...
                              Text("Let's get started",overflow: TextOverflow.ellipsis,
                                  style:
                                  TextStyle(fontFamily: "",color: Colors.white,fontWeight: FontWeight.bold, fontSize: 20)),
                            ],
                          ),
                        ),
                        ...
                        Container(
                          ...
                          child:  TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintStyle: TextStyle(color: Colors.black.withOpacity(0.8),fontSize: 12),
                              icon: Icon(CupertinoIcons.mail,color: Colors.black.withOpacity(0.8),),
                              //suffixIcon: Icon(CupertinoIcons.eye,color: Colors.black.withOpacity(0.5),)
                              //helperText: "Email Address"
                              //labelText: "Email Address"
                            ),
