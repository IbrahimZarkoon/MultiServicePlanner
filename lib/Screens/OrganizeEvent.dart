...
class _OrganizeEventState extends State<OrganizeEvent> {
  ...
  orgEventRequest(
      ...
      String timings,
      XFile bannerImg,
      List<XFile> relatedPics,
      String venueName,
      String venueMapLink) async {
    final String url =
        "https://everythingforpageants.com/msp/api/serviceDetails.php";
    print(loc);
    print(about);
    print(serviceId);
    print(userId);
    ...
    if (response.statusCode == 200 || response.statusCode == 201) {
      ...
      Provider.of<OrganizeEventProvider>(context, listen: false)
          .resetRegOrgProv();

      Navigator.push(context,
          CupertinoPageRoute(builder: (_) => OrgDashboard(orgTabIndex: 0)));
    } else {
                ...
                children: [
                  InkWell(
                    ...
                    child: Container(
                      ...
                      alignment: Alignment.center,
                      child: Text(
                        _selectedTab == 2 ? "Publish event" : "Next",
                        style: const TextStyle(
                            color: Colors.white, fontFamily: "Helvetica_Bold"),
                      ),
                    ),
                  ),
                ],
