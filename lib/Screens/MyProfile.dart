...
class _MyProfileState extends State<MyProfile> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      image: const DecorationImage(
                          ...
                          fit: BoxFit.cover),
                      border: Border.all(color: const Color(0xffff1f6f), width: 2.5)),
                ),
                ...
                Column(
                  children: [
                    Text("Ibrahim Khan Zarkoon",maxLines: 1,overflow: TextOverflow.ellipsis,
                      style: TextStyle(color: Colors.black.withOpacity(0.8),fontFamily: "Helvetica_Bold",fontSize: 17),),
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Container(
                                      ...
                                      child: const Icon(Icons.edit_outlined,size: 15,color: Color(0xffff1f6f),),
                                    ),

                            const Text("Edit Profile",
                              style: TextStyle(color: Color(0xffff1f6f),fontFamily: "",fontWeight: FontWeight.bold,fontSize: 12),),
                          ],
                        ),
                      ),
                    ),
          ...
          InkWell(
              onTap: () => Navigator.push(context, CupertinoPageRoute(builder: (BuildContext context) => const EditPreferences())),

              child: profileCon(context,"Edit Preferences",true)),

          InkWell(
              onTap: () => Navigator.push(context, CupertinoPageRoute(builder: (BuildContext context) => const MyEvents())),
              child: profileCon(context, "My Events",false)),

          InkWell(
              onTap: () => Navigator.push(context, CupertinoPageRoute(builder: (BuildContext context) => const OrganizeEvent())),
              child: profileCon(context, "Start a new event",false)),

          profileCon(context, "Purchase History",false),

          InkWell(
              onTap: () => Navigator.push(context, customRoute(const SettingsPage())),
              child: profileCon(context, "Settings",false)),

          InkWell(
              child: profileCon(context, "Support",false)),
  ...
  Widget memberCon(BuildContext context, String title,String image,String desc)
  {
    return Container(
      padding: const EdgeInsets.all(15),
      child: Row(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(title,overflow: TextOverflow.ellipsis,maxLines: 1,
                  style: TextStyle(fontFamily: "Helvetica_Bold",color: Colors.black.withOpacity(0.8),fontSize: 14,),),

                const SizedBox(height: 5,),

                Text(desc,overflow: TextOverflow.ellipsis,maxLines: 1,
                  style: TextStyle(fontFamily: "",color: Colors.black.withOpacity(0.6),fontSize: 12,),),
