...
class selfieImageTab extends StatefulWidget {
  ...
  @override
  State<selfieImageTab> createState() => _selfieImageTabState();
}

class _selfieImageTabState extends State<selfieImageTab> with SingleTickerProviderStateMixin{
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text("Your selfie holding your ID document",
