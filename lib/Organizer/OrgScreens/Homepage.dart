...
class _OrgHomePageState extends State<OrgHomePage>
  ...
  void _onDropDownItemChanged(String? newValue) {
    setState(() {
      _selectedItem =
          newValue ?? 'Tap to select'; // Handle null value if needed
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      future: orgProv.getPackagesData(orgProv.orgID),
        ...
        return Scaffold(
          ...
          floatingActionButton: Container(
            decoration: BoxDecoration(
                border:
                    Border.all(color: Colors.white.withOpacity(0.95), width: 5),
              ...
              children: [
                ...
                AnimatedContainer(
                  ...
                  margin: EdgeInsets.only(
                      top: topC ? 0 : 0, left: 15, right: 15, bottom: 15),
                  decoration: BoxDecoration(
                    color: Colors.white,
                    boxShadow: [
                      BoxShadow(
                  ...
                  child: Column(
                    children: [
                      Padding(
                        padding:
                            const EdgeInsets.only(top: 0, left: 15, bottom: 5),
                        child: Row(
                          ...
                          children: [
                            ...
                            DropdownButton<String>(
                              ...
                              onChanged:
                                  _onDropDownItemChanged, // Call this method when an item is selected
                ...
                ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, index) {
                      return Container(
                        ...
                        child: eventCon(
                            context,
                            "https://everythingforpageants.com/msp${orgProv.packagesList[index].bannerImg?.substring(2)}",
                            orgProv.packagesList[index]),
                      );
                    }),
              ],
            ),
  ...
  Widget eventCon(
      BuildContext context, String img, SingleVendorPackagesResponse data) {
    return InkWell(
      onTap: () => showModalBottomSheet(
          isScrollControlled: true,
          context: context,
          builder: (BuildContext context) => OrgSingleEvent(
