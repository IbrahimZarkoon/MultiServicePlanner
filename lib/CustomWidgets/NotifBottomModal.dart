...
class NotifBottomModal extends StatefulWidget {
  const NotifBottomModal({super.key,required this.image,required this.content});
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                              image: AssetImage("assets/images/logos/ICON ; MSP.png"),
                        ...
                        actions: [
                          CupertinoActionSheetAction(
                              onPressed: () async {
                                ...
                                setState(() {
                                  paymentSS = imageTemp; // Assign to the File variable
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Icon(Icons.screenshot_monitor,color: Colors.white,size: MediaQuery.sizeOf(context).height*0.03,),
                      ),

                      Text("Upload Payment Proof",style: TextStyle(
                          color: Colors.black.withOpacity(0.8),fontSize: MediaQuery.sizeOf(context).height*0.02
                      ),),
                ...
                Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Icon(Icons.check,color: Colors.white,size: MediaQuery.sizeOf(context).height*0.03,),
                    ),

                    Text("Confirm / Paid",style: TextStyle(
                        color: Colors.black.withOpacity(0.8),fontSize: MediaQuery.sizeOf(context).height*0.02
                    ),)
